...
def _notas_anteriores_a_restauro(notas):
    ...
    Fecha a classe que os outros detectores nao alcancam: depois de o projeto ser
    reposto para tras o ficheiro continua a existir e o simbolo pode ate existir -
    a nota e que descreve uma versao que ja nao esta la, e nada no texto dela o
    denuncia. O criterio e temporal: conta so a nota escrita antes do restauro,
    porque a reescrita depois ja descreve o codigo de agora. A cura e reescrever a
    nota, e o aviso desaparece sozinho quando isso acontece.
    """
