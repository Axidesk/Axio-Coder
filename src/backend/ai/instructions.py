...
def build_system_instructions(modo, contexto_memoria, contexto_ai_memory, bloco_continuidade, contexto_projeto="", contexto_codigo="", contexto_edicoes="", tem_web_search=True, use_deepseek=False, mensagem_usuario="", ai_model="gemini"):
    ...
    instrucao += (
        ...
        "melhoria e feita na mesma rodada, tipicamente no fim. E OBRIGADO a agir quando sentir atrito real: (a) chamou a mesma "
        ...
        "quando existirem - se ele aparecer, ou CONSERTA a causa de facto ou explica por que nao e atrito. Regras da melhoria: "
        ...
        "memoria/glossario. FECHO DO BLOCO: escreve 'AUTO-MELHORIA' no relatorio final SO quando houve melhoria de facto - "
        "nesse caso, curto, com (i) a ferramenta alterada em ficheiro:funcao:linha, (ii) o atrito que a motivou e (iii) a prova "
        "do teste. Se nada foi melhorado, NAO escrevas o bloco, nem a palavra 'nenhuma', nem a justificacao de que nao houve "
        "atrito: o bloco ausente ja significa 'nenhuma'. Unica excecao: se o radar apontar um atrito real que decidiste NAO "
        "corrigir nesta rodada, escreve uma unica linha 'AUTO-MELHORIA (nao corrigida): <motivo>'. Nunca repitas este bloco "
        "em rodadas seguidas com o mesmo texto.\n"
    )
